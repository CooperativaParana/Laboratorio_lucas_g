      ...
      >
        <VStack spacing={6} align="center">
          <Text as="h1" fontSize="3xl" fontWeight="bold" mb={6}>
            Gráficas - Análisis {getTipoAnalisis()}
          </Text>
          <Text fontSize="lg" color="gray.600" mb={6}>
            Gráficas del análisis {getTipoAnalisis().toLowerCase()}
          </Text>
          <Box w="100%" p={4} border="1px" borderColor="gray.200" borderRadius="md">
            <Text fontSize="md" color="gray.500">
              Aquí se mostrarán las gráficas y consultas del análisis {getTipoAnalisis().toLowerCase()}
            </Text>
          </Box>
          <Button
            colorScheme="gray"
